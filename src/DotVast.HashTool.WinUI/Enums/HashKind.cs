...
internal static class HashKindExtensions
{
    ...
    public static IHasher ToIHasher(this HashKind hashKind)
    {
        return hashKind switch
        {
            ...
            HashKind.MD5 => new DotVast.Hashing.NativeCrypto.MD5(),
            HashKind.SHA1 => new DotVast.Hashing.NativeCrypto.SHA1(),
            ...
            HashKind.SM3 => new DotVast.Hashing.NativeCrypto.SM3(),
            ...
            HashKind.BLAKE3 => new DotVast.Hashing.NativeCrypto.BLAKE3(),
            ...
            HashKind.RIPEMD_128 => new DotVast.Hashing.NativeCrypto.RIPEMD128(),
            HashKind.RIPEMD_160 => new DotVast.Hashing.NativeCrypto.RIPEMD160(),
            HashKind.RIPEMD_256 => new DotVast.Hashing.NativeCrypto.RIPEMD256(),
            HashKind.RIPEMD_320 => new DotVast.Hashing.NativeCrypto.RIPEMD320(),
