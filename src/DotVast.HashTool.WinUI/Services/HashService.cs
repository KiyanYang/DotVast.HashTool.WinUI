...
internal sealed partial class HashService : IHashService
{
    ...
    {
        [HashKind.CRC_32_V42] = new("CRC-32", Aliases: ["CRC-32/ADCCP", "CRC-32/V-42", "CRC-32/XZ", "PKZIP", "CRC-32/ISO-HDLC"], IsEnabledForApp: true),
        [HashKind.CRC_64_ECMA182] = new("CRC-64", Aliases: ["CRC-64/ECMA-182"], IsEnabledForApp: true),
        [HashKind.MD4] = new("MD4"),
        [HashKind.MD5] = new("MD5", IsEnabledForApp: true, IsEnabledForContextMenu: true),
        [HashKind.SHA1] = new("SHA-1", Aliases: ["SHA1"], IsEnabledForApp: true, IsEnabledForContextMenu: true),
        [HashKind.SHA2_224] = new("SHA-224", Aliases: ["SHA224"]),
        [HashKind.SHA2_256] = new("SHA-256", Aliases: ["SHA256"], IsEnabledForApp: true, IsEnabledForContextMenu: true),
        [HashKind.SHA2_384] = new("SHA-384", Aliases: ["SHA384"], IsEnabledForApp: true, IsEnabledForContextMenu: true),
        [HashKind.SHA2_512] = new("SHA-512", Aliases: ["SHA512"], IsEnabledForApp: true, IsEnabledForContextMenu: true),
        ...
        [HashKind.XxHash32] = new("XXH32", Aliases: ["xxHash32"], IsEnabledForApp: true, IsEnabledForContextMenu: true),
        [HashKind.XxHash64] = new("XXH64", Aliases: ["xxHash64"], IsEnabledForApp: true, IsEnabledForContextMenu: true),
        [HashKind.XxHash3] = new("XXH3", Aliases: ["xxHash3"], IsEnabledForApp: true),
        ...
        [HashKind.RIPEMD_160] = new("RIPEMD-160", Aliases: ["RIPEMD160"], IsEnabledForApp: true),
        [HashKind.RIPEMD_256] = new("RIPEMD-256", Aliases: ["RIPEMD256"]),
        [HashKind.RIPEMD_320] = new("RIPEMD-320", Aliases: ["RIPEMD320"]),
        [HashKind.QuickXor] = new("QuickXor", Aliases: ["QuickXorHash"], Format: HashFormat.Base64),
        [HashKind.Ed2k] = new("eD2k"),
        [HashKind.HAS_160] = new("HAS-160", Aliases: ["HAS160"]),
    };
